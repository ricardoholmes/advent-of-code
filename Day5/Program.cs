        ...
        public static void calculate(int[] nums)
        {
            ...
            while (nums[i] != 99)
            {
                ...
                else if (id0 == '3' || id0 == '4')
                {
                    ...
                    {
                        Console.Write("Input: ");
                        nums[pos] = Convert.ToInt32(Console.ReadLine());
                        Console.WriteLine();
                    }
