    ...
    class Program
    {
        static void Main()
        {
            ...
            for (int i = 0; i < wire1.Length; i++)
            {
                ...
                if (direction == 'U')
                {
                    int[] info = { up1[x] + magnitude, right1[x] };
                ...
                {
                    int[] info = { up1[x], right1[x] + magnitude };
            ...
            {
                char direction = wire2[i][0];
                int magnitude = Convert.ToInt32(wire2[i].Substring(1));

                if (direction == 'U')
                {
                    int[] info = { up2[x] + magnitude, right2[x] };
                ...
                {
                    int[] info = { up2[x], right2[x] + magnitude };
            ...
            for (int i = 0; i < right2.Count; i++)
            {
                if (right1.Contains(right2[i]) && up1.Contains(up2[i]))
                {
                    int distances = Math.Abs(right2[i]) + Math.Abs(up2[i]);
                    Console.WriteLine(distances);
                    intersections.Add(distances);
                }
            }
            ...
            {
                if (right2.Contains(right1[i]) && up2.Contains(up1[i]))
                {
                    int distances = Math.Abs(right1[i]) + Math.Abs(up1[i]);
                    Console.WriteLine(distances);
                    intersections2.Add(distances);
                }
            }
